...
const Skills: React.FC = () => {
  const categories = [
    ...
    { id: 'testing', title: 'Testing Excellence', description: 'Ensuring stability with , Cypress, Jasmine, Karma, and Vitest.' },
    ...
    <section id="skills" className="py-24">
      ...
      <div className="text-center mb-20">
        ...
        <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto text-lg leading-relaxed">
          A senior-level toolkit built on 6.5+ years of delivering high-concurrency, enterprise-grade software.
        </p>
      </div>
