...
const Navbar: React.FC<NavbarProps> = ({ isDarkMode, toggleTheme }) => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      isScrolled ? 'glass-nav bg-white/80 dark:bg-slate-950/80 border-b border-slate-200 dark:border-slate-800 py-3' : 'bg-transparent py-5'
    }`}>
      ...
      <div className={`lg:hidden absolute top-full left-0 right-0 bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800 transition-all duration-300 ${
